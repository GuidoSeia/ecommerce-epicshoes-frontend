  ...
  return (
    <div>
        ...
        <div class="flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center">
            ...
            <h1 className="text-white font-bold text-4xl font-sans">Are you not registered?</h1> 
            <div className='flex'>
                <Link to="/signup"><button type="submit" className="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold m-2">Sign Up</button></Link>  
                <Link to="/"><button type="submit" className="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold m-2">Go Home</button></Link>  
            </div>
            </div>
        </div>
